...
What forking cannot reach is Flare's instruction relay, which needs a registered TEE machine and a running proxy, and a real FDC attestation round, which needs the verifier API key.
