...
What forking still cannot reach is Flare's instruction relay, which needs a registered TEE machine and a running proxy, and a real attestation being finalised in a voting round.
